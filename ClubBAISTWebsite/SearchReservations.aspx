<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="SearchReservations.aspx.cs" Inherits="ClubBAISTWebsite.SearchReservations1" %>
    ...
    <asp:Wizard runat="server" ID="wizSearchReservation" DisplaySideBar="false" ActiveStepIndex="0" OnFinishButtonClick="wizSearchReservation_FinishButtonClick" OnNextButtonClick="wizSearchReservation_NextButtonClick">
        ...
        <asp:WizardStep>
            ...
            <asp:WizardStep>
                ...
                <asp:Calendar runat="server" ID="calStartDate" />
            </asp:WizardStep>
            <asp:WizardStep>
